...
import config from '../config/ausozlottoConfig';

class AUSOzLotto extends Component {
  constructor() {
    super();
...
multiplier(num) {
  ...
  if(num === 7 || num === 10) {
   bonus +=  1.12;
 } else if(num === 33 || num === 32) {
   bonus +=  1.11;
 }else if(num === 19 || num === 11) {
   bonus +=  1.11;
 }else if(num === 45 || num === 14) {
   bonus +=  1.10;
   ...
   bonus +=  1.6;
 }else if(num === 3 || num === 39) {
   bonus +=  1.06;
 }else if(num === 29 || num === 17) {
   bonus += 1.05;
 }else if(num === 37 || num === 4) {
   bonus +=  1.05;
 }else if(num === 1 || num === 8) {
   bonus +=  1.04;
 }else if(num === 20 || num === 31) {
   bonus +=  1.04;
 }else if(num === 44 || num === 12) {
   bonus +=  1.03;
 }else if(num === 40 || num === 5) {
   bonus +=  1.03;
 }else if(num === 43 || num === 9) {
   bonus +=  1.02;
 }else if(num === 36 || num === 6) {
   bonus +=  1.02;
 } else if(num === 41 || num === 35) {
   bonus +=  1.01;
